...
public struct Bound
{
    ...
    public int2 max => position + sizes;
    ...
    public void GetPositionsGrid(out NativeArray<int2> positions, Allocator allocator = Allocator.TempJob)
    {
    ...
    public void GetPositionsIndexArrayXY(out NativeArray<int> positions, int2 mapSizes, Allocator allocator = Allocator.TempJob)
    {
        int size = sizes.x * sizes.y;

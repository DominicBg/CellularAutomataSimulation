...
//        NativeArray<Glowing> lightSources = new NativeArray<Glowing>(length, Allocator.TempJob);
//        NativeArray<int2> lightPositions = new NativeArray<int2>(length, Allocator.TempJob);
//        for (int i = 0; i < lightSources.Length; i++)
//        {
//            Glowing source = sources[i].GetLightSource(out int2 pos);
...
//        [ReadOnly] public NativeArray<Glowing> lightSources;
